...
class GenericCVS_extend_High_freq(GenericCSVData):
    """
...
class TotalValue_High_freq(bt.analyzers.Analyzer):
    """
...
class MyStrategy_High_freq(bt.Strategy):
    """
